...
import { CircuitBackground } from "@/components/circuit-background";
import { useTranslation } from "@/hooks/useTranslation";
import { useWalletStore } from "@/lib/stores/use-wallet-store"; // ✅ Import your wallet store
...
export default function RegisterPage() {
  ...
  // ✅ use wallet hook instead of manual connect
  const { address, connectWallet, isConnected } = useWalletStore();
